                ...
                <section class="post-area">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('assets/img/archive/c1.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('assets/img/archive/c2.jpg')}}" alt="">
                                </div>
                                <div class="post-details">
                                    <h4><a href="#">An Stormy Evening</a></h4>
                                    <p>There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('assets/img/archive/c3.jpg')}}" alt="">
                                </div>
                                <div class="post-details">
                                    <h4><a href="#">An Stormy Evening</a></h4>
                                    <p>There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('assets/img/archive/c4.jpg')}}" alt="">
                                </div>
                                <div class="post-details">
                                    <h4><a href="#">An Stormy Evening</a></h4>
                                    <p>There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s
